...
PhaserGame.prototype = {
    ...
    preload: function () {
        ...
        this.load.atlas('arcade', 'assets/joystick/images/arcade-joystick.png', 'assets/joystick/js/arcade-joystick.json');
        this.load.image('ball', 'assets/joystick/images/beball1.png');
        this.load.image('bg', 'assets/joystick/images/sky5.png');
